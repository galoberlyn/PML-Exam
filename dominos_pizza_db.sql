...
--
-- Host: localhost    Database: dominos_pizza_db
-- ------------------------------------------------------
...
INSERT INTO `migrations` VALUES (5,'2018_10_25_130720_orders',1),(6,'2018_10_25_130805_pizza',1),(7,'2018_10_25_130814_pizza_details',1),(8,'2018_10_25_130828_pizza_toppings',1),(9,'2018_10_25_130837_customer',1);
...
CREATE TABLE `pizza_details` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pizza_details_id` int(11) NOT NULL,
  `size` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `crust` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
LOCK TABLES `pizza_details` WRITE;
...
CREATE TABLE `pizza_toppings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pizza_details_id` int(11) NOT NULL,
  `pizza_area` int(11) NOT NULL,
  `pizza_item` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dump completed on 2018-10-25 21:29:17
